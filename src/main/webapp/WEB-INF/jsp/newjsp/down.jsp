...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25" background="<%=basePath %>houcss/img/main_67.gif" style="padding-left:40px;"><table width="270" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="90" height="24" style="padding-top:3px;"><div align="center" class="STYLE2"><span class="STYLE3">用户:admin</span></div></td>
