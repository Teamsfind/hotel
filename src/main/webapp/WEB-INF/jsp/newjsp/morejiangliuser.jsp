	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">${VacDatalistname} -- 员工的所有奖励</h3>
				...
				<div class="panel-body">
					...
					<table id="example-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody >
							<c:forEach items='${Awardcostall}' var="i" varStatus="k">  
				                <tr>  
				                	<td>${k.count}</td> 
				                    <td>${i.userNumber }</td> 
				                    <td>${i.username }</td>
				                    ...
				                    <td>${i.awardTime }</td>
				                    <td><input type='button' value='返回' onclick="sureTravel(${i.userNumber })">
				                    	  </td> 
				                </tr>  
			           		</c:forEach>  
						</tbody>
		...
		<script type="text/javascript">
			function sureTravel() {
				...
				window.location.href='<%=basePath%>manager/toJiangLiUser';
			}
		</script>
